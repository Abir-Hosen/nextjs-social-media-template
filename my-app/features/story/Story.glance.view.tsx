...
export interface StoryGlanceViewProps {
    children?: never;
}

export const StoryGlanceView: FunctionComponent<StoryGlanceViewProps> = () => {
    return (
        <>
        <div className="card card-body">
          <div className="d-flex mb-3">
            <div className="avatar avatar-xs me-2">
              <a href="#"> <img className="avatar-img rounded-circle" style={{height: '40px', width:'40px'}} src="https://static.toiimg.com/photo/79170990.cms" alt=""/> </a>
            </div>
